...
namespace Hse.Platform.Migrations
{
    ...
    [Migration("20260815204145_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hse.Platform.Organization.Employee", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<string>("NationalIdCiphertext")
                        .HasMaxLength(512)
                        .HasColumnType("nvarchar(512)");

                    b.Property<string>("NationalIdIndex")
                        .HasMaxLength(128)
                    ...
                    b.HasIndex("TenantId", "NationalIdIndex");

                    b.ToTable("Employees", "org");
                });

            modelBuilder.Entity("Hse.Platform.Workflow.WorkflowDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hse.Platform.Workflow.WorkflowHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hse.Platform.Workflow.WorkflowInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hse.Platform.Workflow.WorkflowDefinition", b =>
                {
                    b.OwnsMany("Hse.Platform.Workflow.WorkflowStateRecord", "States", b1 =>
                        {
                            ...
                            b1.ToTable("WorkflowStates", "wf");

                            b1.WithOwner()
                                .HasForeignKey("DefinitionId");
                        });

                    b.OwnsMany("Hse.Platform.Workflow.WorkflowTransitionRecord", "Transitions", b1 =>
                        {
                            b1.Property<Guid>("DefinitionId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Property<string>("RequiredPermission")
                                .HasMaxLength(256)
                                .HasColumnType("nvarchar(256)");
                            ...
                            b1.ToTable("WorkflowTransitions", "wf");
