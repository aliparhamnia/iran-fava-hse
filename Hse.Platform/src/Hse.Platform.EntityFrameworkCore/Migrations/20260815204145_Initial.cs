...
namespace Hse.Platform.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalIdCiphertext = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    NationalIdIndex = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkflowStates", x => new { x.DefinitionId, x.Id });
                    table.ForeignKey(
                        name: "FK_WorkflowStates_WorkflowDefinitions_DefinitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkflowTransitions", x => new { x.DefinitionId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_TenantId_NationalIdIndex",
                schema: "org",
                table: "Employees",
                columns: new[] { "TenantId", "NationalIdIndex" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowDefinitions_TenantId_EntityType_Version",
                schema: "wf",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowHistories_InstanceId",
                schema: "wf",
